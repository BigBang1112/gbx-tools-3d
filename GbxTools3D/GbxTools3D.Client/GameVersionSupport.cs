...
{
    public static ImmutableArray<GameVersion> Versions => [GameVersion.TMF, GameVersion.TM2020, GameVersion.MP4, GameVersion.TMT, GameVersion.TMSX, GameVersion.TMNESWC];
