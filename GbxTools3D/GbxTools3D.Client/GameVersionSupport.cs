...
{
    public static ImmutableArray<GameVersion> Versions => [GameVersion.MP4, GameVersion.TMT, GameVersion.TMF, GameVersion.TMSX, GameVersion.TMNESWC, GameVersion.TM2020];
